...
const MyStringFunctions = require("./MyStringFunctions");
 ...
 class Students extends Members {
    ...
    updateGrade(sGrade)
    {
        this.student.sGrade = sGrade.toUpperCase();
    }
    ...
    */
     ...
     */
     ...
     changeStudentCourse(newStudentCourse) {
        if (this.#isCourseNameValid(newStudentCourse) && newStudentCourse !== this.student.sCourseName)
        {
          this.student.sCourseName = newStudentCourse;
          console.log (`You change your course: ${newStudentCourse}`);
        
        }
        else
        {
            console.log (`${newStudentCourse} course is INVALID`)
        }
      }
...
{
    console.log(`Thank you for making payment of $${amount} you balance is $${this.student.sBalance-amount}`);
        }
      else if (this.student.sBalance === 0) {
      console.log (`No more payment required`);   
      return this.student.sBalance = 0
      }
     else  {
